...
class ReactionSystem:
    ...
    REACTION_TRIGGERS = {
        ...
        # Humor
        "funny": {
            "keywords": ["lol", "lmao", "haha", "hehe", "rofl", "😂", "🤣", "joke", "funny", "hilarious"],
            "emojis": ["😂", "🤣", "💀", "😆"],
            "chance": 0.7,
        },
        # Sadness
...
Return ONLY the emoji character, nothing else."""
    ...
    async def respond_to_reaction(self, reaction: discord.Reaction, user: discord.User) -> Optional[str]:
        ...
        responses = {
            ...
            "❤️": ["Aw thanks! 💕", "You're sweet!", "❤️"],
            "😂": ["Hehe glad that landed!", "I try! 😄", "Comedy gold, I know"],
            "🔥": ["You know it! 🔥", "Fire recognizes fire", "💪"],
            "👀": ["👀", "I see you seeing me", "Interesting, right?"],
            "🤔": ["Need me to explain more?", "Got questions?", "What's on your mind?"],
            "💯": ["Straight facts!", "100%!", "You get it! 💯"],
        }
    ...
    def generate_comment(self, activity_info: Dict) -> Optional[str]:
        ...
        if activity_type == "game":
            comments = [
                ...
                f"{activity}? Have fun, {user.display_name}! 🎮",
                f"👀 {user.display_name} jumping into {activity}",
        ...
        # Stream comments
            ...
            comments = [
                f"Oh {user.display_name} is streaming! Good luck! 🎥",
                f"Stream time! Go {user.display_name}! 📺",
                f"👀 {user.display_name} went live!",
            ]
            return random.choice(comments)
        ...
        # Spotify comments
            ...
            comments = [
                f"🎵 {user.display_name} is listening to {activity}",
                f"Ooh good taste! {activity} 🎶",
                f"Nice track choice, {user.display_name}! 🎧",
            ]
            return random.choice(comments)
